...
![Fernando Doglio](./assets/images/mini-fernando-doglio.jpg)

Hello there! Thanks for checking out my small little corner on the Internet. 

My name is Fernando Doglio, I'm a Technical Manager, who's been [working as a technical writer](https://www.fdoglio.com/writing-for-others) for the past year or so, and I'd like to think I've learned a few things along the way.
...
Like I said, I've been writing for a few years now, both in blog format in multiple, failed, personal blogs. They where all technical blogs though, places where I would try to explain concepts from my day-to-day job to others. And although I still do that, I mainly do it in a freelance writer mode (in other words, I write for other companies tech blogs about software development and get paid for it). [Here is a updated list](https://www.fdoglio.com/writing-for-others) of my recent freelance writing work in case you're looking for some writing examples.

And over the years, I've also managed to write a few Technical Books both for [Apress.com](http://apress.com) and [PactkPub](http://packtpub.com), both very well known publishers of technical books. Here is a list of my work:
